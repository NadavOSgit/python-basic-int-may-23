...
print("whole_input_split", whole_input_split)
print("type(whole_input_split)", type(whole_input_split))

# Stage 3 - convert any value and store the value (using loop with iterations)
score_1 = int(whole_input_split[0])
score_2 = int(whole_input_split[1])
score_3 = int(whole_input_split[2])
score_4 = int(whole_input_split[3])
score_5 = int(whole_input_split[4])
